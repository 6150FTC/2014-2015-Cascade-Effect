...
{
    float balanceAdjustmentPercent = .56;//64 at beginning //percent to adjust power to counter weight imbalance. float based on power of 70;
...
void openScoopGate(int state)
{
    ...
    {
        servo[ScoopGate] = 100;//Scoop gate stable
    }
    else
    {
