...
#pragma config(Sensor, S3,     topLimitSwitch, sensorNone)
#pragma config(Sensor, S4,     IrSeeker,       sensorNone)
#pragma config(Motor,  motorA,           ,             tmotorNXT, openLoop)
#pragma config(Motor,  motorB,           ,             tmotorNXT, openLoop)
#pragma config(Motor,  motorC,           ,             tmotorNXT, openLoop)
#pragma config(Motor,  mtr_S1_C1_1,     lift,          tmotorTetrix, PIDControl, encoder)
...
#define AUTO_LIFT_SPEED 80
#define TWEAK_LIFT_SPEED 40
...
task main()
{
    ...
    while(true)
    {
      ...
      if(!LIFT_LOWER)
      {
        ...
        sprintf(buffer, "%d", nMotorEncoderTarget[lift]);
