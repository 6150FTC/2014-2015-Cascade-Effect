...
#include "DriveSingleEncoder_2015_02_10.c"
#include "AutoBaseKick_2015_02_12.c"
#include "AutoRamp_2015_02_08.c"
...
task main()
{
    ...
    bool actionSelector = true; // will this work  or will it point to what ever is in the 1 place in ram.
    int grabBase = -1;
    char *actionString = "none";
    openScoopGate(stable);//servo will stablilize in ready phase of autonomous.
